...
public class FileAttributeValueReducer {
	
	private List<Integer> headersToFilter;
	private Attribute[] attributes;
	private GroupedAttribute[] groupedAttributes;
	private String[] headers;
	private AttributeValueReducer attributeValueReducer;
	
	public FileAttributeValueReducer(AttributeValueReducer attributeValueReducer) {
		setAttributeValueReducer(attributeValueReducer);
...
//				}
				newAttribute = attributeValueReducer.group(attribute, trueValue);
			}
			else {
	...
	public AttributeValueReducer getAttributeValueReducer() {
		return attributeValueReducer;
	}

	public void setAttributeValueReducer(AttributeValueReducer attributeValueReducer) {
		this.attributeValueReducer = attributeValueReducer;
	}
